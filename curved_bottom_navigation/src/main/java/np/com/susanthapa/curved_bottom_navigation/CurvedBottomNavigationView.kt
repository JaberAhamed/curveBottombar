...
class CurvedBottomNavigationView @JvmOverloads constructor(
    ...
    var selectedColor = Color.parseColor("#8F8F8F")
        set(value) {
            field = value
    ...
    private val curveBottomOffset = 38

    // radius of the FAB
    private val fabRadius = 45
    ...
    private val topControlX = fabRadius + fabRadius / 8
    private val topControlY = bottomNavOffsetY + fabRadius / 16

    // offset of the bottom control point (independent of curves)
    private val bottomControlX = fabRadius + (fabRadius / 16)
    private val bottomControlY = fabRadius / 8
    ...
    override fun onDraw(canvas: Canvas) {
      ...
      //  canvas.drawOval(centerX, curCenterY, fabSize / 2f, fabPaint)
        drawRhombus(canvas, navPaint,centerX.toInt(),curCenterY.toInt(),120 )
